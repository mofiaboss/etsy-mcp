...
from etsy_mcp_shared.protocol import create_mcp_tool_adapter, get_protocol_version
...
class TestGetProtocolVersion:
    ...
    def test_reads_from_env(self, monkeypatch):
        monkeypatch.setenv("ETSY_MCP_PROTOCOL_VERSION", "v2")
        assert get_protocol_version() == "v2"

    def test_strips_whitespace(self, monkeypatch):
        monkeypatch.setenv("ETSY_MCP_PROTOCOL_VERSION", "  v1  ")
        assert get_protocol_version() == "v1"
